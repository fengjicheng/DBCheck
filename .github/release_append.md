...
```powershell
docker pull jackge12345/dbcheck:v26.9.14.1
...
```powershell
docker pull ghcr.io/fiyo/dbcheck:v26.9.14.1
...
```powershell
docker run -d -p 5003:5003 --name raccoonx jackge12345/dbcheck:v26.9.14.1
```
